  ...
  <head>
    ...
    <link href="resources/css/AdminLTE.css" rel="stylesheet" type="text/css"/>
     ...
     <body class="hold-transition skin-red sidebar-mini">
      ...
      $listaRoles=$rolDao->listarTodosAdmin();
      ?>
      <div class="wrapper">
  ...
  <li><a href="fase.php"><i class="fa nav-icon fas fa-columns"></i> Fase</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
                      ...
                      <div class="col-12">
                        <div class="card">
                          <div class="card-header bg-dark">
                            <h3 class="card-title text-center text-light">Roles</h3>
                          </div>
                          <div class="card-body">
                                ...
                                foreach($listaRoles as $rol)
                                {
                                  ...
                                  <tr>
                                    ...
                                    <td class="project-actions text-right">
                                      ...
                                      <a class="btn btn-info btn-sm" alt="Editar" title="Editar" data-toggle="modal" href="#modal-modificar<?php echo $rol['idRol']; ?>">
                                        <i class="fas fa-pencil-alt" >
                                        </i>

                                      </a>
                                      <a class="btn btn-danger btn-sm" alt="Eliminar" title="Eliminar" data-toggle="modal" href="#modal-eliminar<?php echo $rol['idRol']; ?>">
                                  ...
                                  <div class="modal fade" id="modal-modificar<?php echo $rol['idRol']; ?>">
                                          ...
                                          <form action="controladores/ControladorRol.php" method="POST">
                                            <div class="row">
                                              ...
                                              <div class="col-12">
                                                ...
                                                <input type="hidden" id="txtIdRolM" name="txtIdRolM" class="form-control" placeholder="IdRol"  value="<?php echo $rol['idRol']; ?>">
        ...
        <div class="col-12">
          <label  for="txtNombreRolM"><strong>Nombre *</strong></label>
          <input type="text" id="txtNombreRolM" name="txtNombreRolM" placeholder="Nombre" class="form-control" required="true" pattern="[A-Za-z ]+" maxlength="45" minlength="3"  value="<?php echo $rol['nombreRol']; ?>">
                                    ...
                                    <div class="modal-footer justify-content-between">
                                      ...
                                      <input type="submit" class="btn btn-primary" name="btnModificarRol" value="Actualizar" />
                                    </div>
                                  </form>  
                                </div>
                              </div>
                          ...
                          <div class="modal fade" id="modal-eliminar<?php echo $rol['idRol']; ?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header bg-dark">
                                  <h4 class="modal-title text-center text-light">Eliminar Rol</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  <form action="controladores/ControladorRol.php" method="POST">
                                    <input type="hidden" name="txtIdRolEliminar" class="form-control" placeholder="IdRol"  value="<?php echo $rol['idRol']; ?>"/>


                                    <p class="text-center">¿Esta seguro de eliminar el rol?</p>
                                    <h2 class="text-center"><?php echo $rol['nombreRol']; ?></h2>
                                    ...
                                    <div class="modal-footer justify-content-between">
                                      ...
                                      <input type="submit" class="btn btn-danger" name="btnEliminarRol" value="Aceptar" />
                                    </div>
                                  </form>  
                                </div>
                              </div>
  ...
  <div class="modal fade" id="modal-default">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header bg-dark">
          <h4 class="modal-title text-center text-light">Registrar Rol</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form id="form1" action="controladores/ControladorRol.php"  enctype="multipart/form-data" method="POST" >
            <div class="row">
              <div class="col-12 text-md-right"><strong> * Campo requerido</strong> </div>
              <div class="col-12">
              <label  for="txtNombreRolR"><strong>Nombre *</strong></label>
              <input type="text" id="txtNombreRolR" name="txtNombreRolR" placeholder="Nombre" class="form-control" required="true" pattern="[A-Za-z ]+" maxlength="45" minlength="3" >
               </input>
      </div>
  ...
  <div class="modal-footer justify-content-between">
    <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
    <input type="submit" class="btn btn-primary" name="btnRegistrarRol" value="Registrar"/> 
  </div>
